...
import { TransactionList } from "../base/wrappers";
...
export type OPTBUYTYPE = "BUYTOOPEN" | "BUYTOCLOSE";

export type OPTSELLTYPE = "SELLTOOPEN" | "SELLTOCLOSE";
...
export type OPTACTION = "EXERCISE" | "ASSIGN" | "EXPIRE";
...
export type SELLREASON = "CALL" | "SELL" | "MATURITY";
...
export type RELTYPE = "SPREAD" | "STRADDLE" | "NONE" | "OTHER";
...
export interface INVTRANLIST extends TransactionList {
  dtstart: Date;
