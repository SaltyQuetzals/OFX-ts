...
export type DEBTTYPE = "COUPON" | "ZERO";

export type DEBTCLASS = "TREASURY" | "MUNICIPAL" | "CORPORATE" | "OTHER";
...
export type CALLTYPE = "CALL" | "PUT" | "PREFUND" | "MATURITY";
...
export type MFTYPE = "OPENEND" | "CLOSENED" | "OTHER";
...
export type STOCKTYPE = "COMMON" | "PREFERRED" | "CONVERTIBLE" | "OTHER";
...
export interface SECLISTTRNRQ extends TransactionRequest {
  seclistrq: SECLISTRQ;
}
...
/** OFX section 13.8.2.1 */
export interface SECLISTTRNRS extends TransactionResponse {
  seclistrs?: SECLISTRS;
}
