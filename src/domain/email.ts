...
/**
  *  OFX section 9.2.3
  */
export interface MAILTRNRQ extends TrnRq {
  mailrq: MAILRQ
}
...
/**
  *  OFX section 9.2.3
  */
export interface MAILTRNRS extends TrnRs {
  trnuid: string
  cltcookie?: string
...
/**
  *  OFX section 9.2.4
  */
export interface MAILSYNCRQ extends SyncRqList {
...
/**
  *  OFX section 9.2.4
  */
export interface MAILSYNCRS extends SyncRsList {
  mailtrnrs?: MAILTRNRS[]
}
...
/**
  *  OFX section 9.3.1
  */
export interface GETMIMETRNRQ extends TrnRq {
  getmimerq: GETMIMERQ
}
...
/**
  *  OFX section 9.3.2
  */
export interface GETMIMETRNRS extends TrnRs {
  trnuid: string
  status: STATUS
  cltcookie?: string
  ofxextension?: OFXEXTENSION
